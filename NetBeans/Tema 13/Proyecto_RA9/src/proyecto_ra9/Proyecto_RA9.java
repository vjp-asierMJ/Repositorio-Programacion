 ...
 */
package proyecto_ra9;

import java.sql.*;

public class Proyecto_RA9 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            ResultSet rs = statement.executeQuery( //ejecutamos un select y lo guardamos en la variable
            ...
            String sqlInsert = "INSERT INTO alumnos " //igual que statement pero mas seguro y eficiente
            ...
            int filasInsertadas = psInsert.executeUpdate(); //inserte que devuelve el número de filas insertadas
