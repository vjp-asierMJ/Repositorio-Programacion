...
public class Ejercicio6Tema10 {
    ...
    public static void main(String[] args) {
        ...
        try { //Excepciones
            ...
            case 1 -> rellenar(ventas,meses);
            case 2 -> mostrar(ventas,meses);
            case 3 -> mostrarAlReves(ventas,meses);
            case 4 -> totalVentas(ventas);
            case 5 -> ventasMesesA(ventas,meses);
            case 6 -> mesesMasVentas(ventas,meses);
